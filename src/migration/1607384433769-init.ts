...
export class init1607384433769 implements MigrationInterface {
    name = 'init1607384433769'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "tattooer_city_enum" AS ENUM('cherkasy', 'chernihiv', 'chernivtsi', 'dnipro', 'donetsk', 'ivano-frankivsk', 'kharkiv', 'kherson', 'khmelnytskyi', 'kropyvnytskyi', 'kyiv', 'luhansk', 'lutsk', 'lviv', 'mykolaiv', 'odessa', 'poltava', 'rivne', 'sumy', 'ternopil', 'uzhhorod', 'vinnytsia', 'zaporizhzhia', 'zhytomyr', 'kryvyi rih', 'mariupol', 'sevastopol', 'simferopol', 'makiivka', 'kamianske', 'kremenchuk', 'bila tserkva', 'uman')`);
        await queryRunner.query(`CREATE TYPE "tattooer_styles_enum" AS ENUM('blackwork', 'chicano', 'japan', 'neotraditional', 'newschool', 'realism', 'traditional', 'tribal', 'watercolor', 'graphics', 'dotwork', 'linework', 'black grey', 'trash polka', 'color', 'test')`);
        await queryRunner.query(`CREATE TABLE "tattooer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP, "instagram" character varying NOT NULL, "approved" boolean NOT NULL DEFAULT false, "posts" jsonb NOT NULL DEFAULT '[]', "city" "tattooer_city_enum", "styles" "tattooer_styles_enum" array, "profilePic" character varying, "about" character varying, "aboutRaw" character varying, "postsCount" character varying, "followersCount" character varying, "followingCount" character varying, CONSTRAINT "PK_66cd2f2472e6ec52ad07899c901" PRIMARY KEY ("id", "instagram"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "tattooer_styles_enum"`);
        await queryRunner.query(`DROP TYPE "tattooer_city_enum"`);
